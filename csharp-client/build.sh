...
${nuget_cmd} install src/mantle.lib/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/mantle.lib.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/mantle.lib.dll \
-recurse:'src/mantle.lib/*.cs' \
-doc:bin/mantle.lib.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/mantle.lib.dll was created successfully"
fi
