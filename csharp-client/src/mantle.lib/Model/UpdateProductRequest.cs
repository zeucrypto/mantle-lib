...
namespace mantle.lib.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateProductRequest :  IEquatable<UpdateProductRequest>
    {
        /// <summary>
        ...
        public UpdateProductRequest(string Id = default(string), string Name = default(string))
        {
            ...
            if (Name == null)
            {
                throw new InvalidDataException("Name is a required property for UpdateProductRequest and cannot be null");
            }
            else
            {
                this.Name = Name;
