...
namespace mantle.lib.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProductUser :  IEquatable<ProductUser>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductUser" /> class.
        /// </summary>
        ...
        public ProductUser(string Id = default(string), string ClientId = default(string), string Email = default(string), string FirstName = default(string), string LastName = default(string), bool? IsEnabled = default(bool?), BlockchainStatusEnum? BlockchainStatus = default(BlockchainStatusEnum?), List<RolesEnum> Roles = default(List<RolesEnum>))
        {
            this.Id = Id;
        ...
        {
            return this.Equals(input as ProductUser);
        }

        /// <summary>
        /// Returns true if ProductUser instances are equal
        /// </summary>
        /// <param name="input">Instance of ProductUser to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProductUser input)
        {
            if (input == null)
                return false;
