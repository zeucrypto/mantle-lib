...
namespace mantle.lib.Model
{
    ...
    public partial class ContractSignatureDiffResponse :  IEquatable<ContractSignatureDiffResponse>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ContractSignatureDiffResponse {\n");
        ...
        {
            return this.Equals(input as ContractSignatureDiffResponse);
        }

        /// <summary>
        /// Returns true if ContractSignatureDiffResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ContractSignatureDiffResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContractSignatureDiffResponse input)
        {
            if (input == null)
                return false;
